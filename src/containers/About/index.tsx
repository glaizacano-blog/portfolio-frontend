      ...
      <div className="w-5/6 flex flex-col justify-center items-center">
        ...
        <div className="xxs:text-md xs:text-lg sm:text-lg md:text-xl lg:text-xl xl:text-xl 2xl:text-xl xxs:mb-6 xs:mb-6 sm:mb-6 md:mb-6 lg:mb-8 xl:mb-8 2xl:mb-8">
          <p className="xxs:my-6 xs:my-6 sm:my-6 md:my-6 lg:my-8 xl:my-8 2xl:my-8">
            I'm currently working as a Software Engineer and have about a year of industry
            experience in software development and over four years of
          ...
          <p className="xxs:text-md xs:text-lg sm:text-lg md:text-xl lg:text-xl xl:text-xl 2xl:text-xl xxs:my-6 xs:my-6 sm:my-6 md:my-6 lg:my-8 xl:my-8 2xl:my-8">
            I work mainly with JavaScript and Angular.js, and I'm currently
            learning other JavaScript frameworks such as React.js and Vue.js. My main areas of
            interest are Front-end Development, User
            Interface Design, but I've also been exploring Back-end Development,
